...
for video in video_files:
    ...
    output_name = os.path.splitext(video)[0] + '_outx3.mp4'
    output_path = os.path.join(output_folder, output_name)

    # Esegui il comando di inferenza con `outscale` 3
    os.system(f"python3 inference_realesrgan_video.py -i {input_path} -n realesr-animevideov3 -s 3 --suffix outx3")
